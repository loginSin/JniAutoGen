...
static jboolean Java_Iterator_hasNext(
    JNIEnv* env,
...
static jboolean Java_Iterator_hasNext(
  ...
  CHECK_CLAZZ(env, obj.obj(), java_util_Iterator_clazz(env), false);

  jni_generator::JniJavaCallContextChecked call_context;
  call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
      env, clazz, "hasNext", "()Z", &g_java_util_Iterator_hasNext);
...
static base::android::ScopedJavaLocalRef<jobject> Java_Iterator_next(
    JNIEnv* env,
    const base::android::JavaRef<jobject>& obj) __attribute__((unused));
static base::android::ScopedJavaLocalRef<jobject> Java_Iterator_next(
    JNIEnv* env,
    const base::android::JavaRef<jobject>& obj) {
  jclass clazz = java_util_Iterator_clazz(env);
  CHECK_CLAZZ(env, obj.obj(), java_util_Iterator_clazz(env), NULL);

  jni_generator::JniJavaCallContextChecked call_context;
  call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
      env, clazz, "next", "()Ljava/lang/Object;", &g_java_util_Iterator_next);
...
static void Java_Iterator_remove(JNIEnv* env,
                                 const base::android::JavaRef<jobject>& obj)
    __attribute__((unused));
static void Java_Iterator_remove(JNIEnv* env,
                                 const base::android::JavaRef<jobject>& obj) {
  jclass clazz = java_util_Iterator_clazz(env);
  CHECK_CLAZZ(env, obj.obj(), java_util_Iterator_clazz(env));

  jni_generator::JniJavaCallContextChecked call_context;
  call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
      env, clazz, "remove", "()V", &g_java_util_Iterator_remove);
...
static void Java_Iterator_forEachRemaining(
    JNIEnv* env,
    const base::android::JavaRef<jobject>& obj,
...
static void Java_Iterator_forEachRemaining(
  ...
  jni_generator::JniJavaCallContextChecked call_context;
  call_context.Init<base::android::MethodID::TYPE_INSTANCE>(
      env, clazz, "forEachRemaining", "(Ljava/util/function/Consumer;)V",
