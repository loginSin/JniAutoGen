...
static base::android::ScopedJavaLocalRef<jobject> Java_Iterable_iterator(
    JNIEnv* env,
...
static base::android::ScopedJavaLocalRef<jobject> Java_Iterable_iterator(
  ...
  CHECK_CLAZZ(env, obj.obj(), java_lang_Iterable_clazz(env), NULL);
...
static void Java_Iterable_forEach(JNIEnv* env,
                                  const base::android::JavaRef<jobject>& obj,
...
static void Java_Iterable_forEach(JNIEnv* env,
                                  ...
                                  const base::android::JavaRef<jobject>& p0) {
  jclass clazz = java_lang_Iterable_clazz(env);
  CHECK_CLAZZ(env, obj.obj(), java_lang_Iterable_clazz(env));
...
static base::android::ScopedJavaLocalRef<jobject> Java_Iterable_spliterator(
    JNIEnv* env,
    const base::android::JavaRef<jobject>& obj) __attribute__((unused));
static base::android::ScopedJavaLocalRef<jobject> Java_Iterable_spliterator(
    JNIEnv* env,
