...
using RongCloud::jni::JavaParamRef;
using RongCloud::jni::JavaRef;
using RongCloud::jni::LazyGetClass;
using RongCloud::jni::MethodID;
using RongCloud::jni::ScopedJavaLocalRef;
